...
function purchaseConfirmation(order = {}) {
  ...
  const inner = `
    ...
    <p style="margin:0 0 14px;"><strong>What to expect:</strong> because everything is crafted fresh in small batches, your order will arrive in <strong>approximately three shipments</strong> rather than all at once — so don't worry if your first package holds only part of your order. Each piece is on its way as soon as it's ready.</p>
...
What to expect: because everything is crafted fresh in small batches, your order will arrive in approximately three shipments rather than all at once. Don't worry if your first package holds only part of your order — each piece ships as soon as it's ready.
